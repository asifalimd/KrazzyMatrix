...
//    NSLog(@"Entering the background");

    
    [[RtwSetting getSettingsObject] setGameState];
...
//        NSLog(@"Entering the foreground");
    [[RtwSetting getSettingsObject] loadSettings];
//    NSLog(@"Game %@", [RtwSetting getSettingsObject].gameState);
...
//    RtwJigsawMatrix* gameState = [RtwJigsawMatrix singleton];
 ...
 //   NSData *data = [NSKeyedArchiver archivedDataWithRootObject:gameState];
  //  [RtwSetting getSettingsObject].gameState = data;
